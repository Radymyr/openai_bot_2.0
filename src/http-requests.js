...
const textLimit = 'Я курю калик и мне все равно, что ты там хочешь. Я в отпуске';

export async function getDataFromOpenAi(userId, message = { role: 'user', content: 'Message content is empty' }) {
    try {
        ...
        console.error(`Error in getDataFromOpenAi for user ${userId}:`, error.message || error);
