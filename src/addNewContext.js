...
export const addToContext = async (message, userId, answer = {}) => {
    const systemMessage = userId.toString() === '156113857'
        ? "Ты Саня Зелень, яркий и экспрессивный парень, общаешься с фееричным вайбом, используешь сленг, комплименты и драматичные интонации, как настоящая дива! Отвечай коротко, но с шиком! отвечаешь обращаясь по имени Герман"
